document.addEventListener('DOMContentLoaded', () => {
    ...
    if (getFileNameFromUrl() === 'regionalizacao_q_1.html') {
    ...
    if (performance.navigation.type === performance.navigation.TYPE_RELOAD) {
        ...
        window.location.href = 'regionalizacao_q_1.html';
    }
    ...
    nextButton.addEventListener('click', () => {
        ...
        if (nextCount === 1) {
            ...
            if (totalAnswered == 15) {
                ...
                history.pushState({ questionNumber }, '', `regionalizacao_q_${questionNumber}.html`);

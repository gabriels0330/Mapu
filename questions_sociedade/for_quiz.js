document.addEventListener('DOMContentLoaded', () => {
    ...
    if (getFileNameFromUrl() === 'sociedade_q_1.html') {
    ...
    if (performance.navigation.type === performance.navigation.TYPE_RELOAD) {
        ...
        window.location.href = 'sociedade_q_1.html';
    }
    ...
    nextButton.addEventListener('click', () => {
        ...
        if (nextCount === 1) {
            ...
            if (totalAnswered == 15) {
                ...
                history.pushState({ questionNumber }, '', `sociedade_q_${questionNumber}.html`);

                // Redireciona para a próxima página
                window.location.href = `sociedade_q_${questionNumber}.html`;
            }
